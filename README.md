Kinetic Art is a physics-based arcade game made for art's sake back in 2010. Uses [Allegro](http://liballeg.org/) for graphics, [Chipmunk](https://chipmunk-physics.net/) for physics and OGG/Vorbis for audio.
